...
function OfferByCategory() {
    const {id} = useParams()


    const[offerbycategory ,setOfferbycategory] =useState([])
    const fetchCategorybyid =async()=>{
        try {
            const res=await api.getByidCategory(id)
         //   console.log('response de fetchCategorybyid' , res.data.data.idoffer)
            setOfferbycategory(res.data.data.idoffer)
        } catch (error) {
   ...
   <div>  <div className="container-xxl bg-white p-0">
    ...
    <div className="container-xxl py-5 bg-dark page-header mb-5">
      <div className="container my-5 pt-5 pb-4">
        <h1 className="display-3 text-white mb-3 animated slideInDown">Job List By Category</h1>
        <nav aria-label="breadcrumb">
          <ol className="breadcrumb text-uppercase">
            <li className="breadcrumb-item"><a href="#">Home</a></li>
            <li className="breadcrumb-item"><a href="#">Pages</a></li>
            <li className="breadcrumb-item text-white active" aria-current="page">Job List By Category</li>
          </ol>
        </nav>
      </div>
    </div>
      ...
      <div className="container">
        ...
        <div className="tab-content">
            <div id="tab-1" className="tab-pane fade show p-0 active">
              {offerbycategory.length>0 ?(
                offerbycategory.slice(0,5).map((i)=>(
